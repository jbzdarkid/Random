...
if __name__ == "__main__":
  ...
  challenges = {
    ...
    # 'SoE A Blue 2':    ['IjLZ',          4, 4],
    # 'SoE A Blue 3':    ['ILttZ',         5, 4],
    ...
    # 'SoE B Blue 1':    ['LLOO',         4,  4],
    # 'SoE B Blue 2':    ['ILLZZ',        4,  5],
    # 'SoE B Blue 3':    ['IjjLL',        4,  5],
    # 'SoE B Blue 4':    ['IjLStt',       4,  6],
    # 'SoE B Blue 5':    ['IjLO',         4,  4],
    # 'SoE B Blue 6':    ['LttZZ',        5,  4],
    # 'SoE B Blue 7':    ['IIjLOS',       6,  4],
    # 'SoE B Blue 8':    ['IjLZ',         4,  4],
    # 'SoE B Green 1':   ['jLLLZ',        4,  5],
    # 'SoE B Green 2':   ['LSSttZ',       4,  6],
    # 'SoE B Green 3':   ['IjLLLLOtt',    6,  6],
    # 'SoE B Green 4':   ['ILLOOOOOOO',   5,  8],
    # 'SoE B Green 5':   ['IjLLOOttZ',    6,  6],
    # 'SoE B Green 6':   ['IIIjLLLOOS',   5,  8],
    # 'SoE B Green 7':   ['jjjjOOOZZ',    6,  6],
    # 'SoE B Green 8':   ['IjOOSttttZ',   5,  8],
    # 'SoE B Yellow 1':  ['IIjOSSttZZ',   4, 10],
    # 'SoE B Yellow 2':  ['jSttZ',        4,  5],
    # 'SoE B Yellow 3':  ['IOttttZ',      7,  4],
    # 'SoE B Yellow 4':  ['ILLLOSSttZ',   4, 10],
    # 'SoE B Yellow 5':  ['IjjjjLOOSStt', 8,  6],
    # 'SoE B Yellow 6':  ['IIjOSSttZZ',   4, 10],
    # 'SoE B Yellow 7':  ['IOttttZ',      7,  4],
    # 'SoE B Yellow 8':  ['IjjLLOOttttZ', 6,  8],
    # 'SoE B Red 1':     ['ISStttt',      4,  7],
    # 'SoE B Red 2':     ['IILLLSttZZ',  10,  4],
    # 'SoE B Red 3':     ['LLLSSttZZZ',  10,  4],
    # 'SoE B Red 4':     ['ILttZ',        5,  4],
    # 'SoE B Red 5':     ['IjOOSttttZ',   5,  8],
    # 'SoE B Red 6':     ['jLSSttttZZ',   5,  8],
    # 'SoE B Red 7':     ['IIJOSSttZZ',   4, 10],
    # 'SoE B Red 8':     ['IjjLLOOttttZ', 6,  8],

    # 'SoE C Blue 1':    ['jjSS',          4, 4],
    # 'SoE C Blue 2':    ['LttZ',          4, 4],
    # 'SoE C Blue 3':    ['jjLLO',         5, 4],
    # 'SoE C Blue 4':    ['IIjLOSSttZ',    8, 5],
    # 'SoE C Blue 5':    ['IIIJOtt',       7, 4],
    # 'SoE C Blue 6':    ['IjjLLOOOO',     6, 6],
    # 'SoE C Blue 7':    ['ILLLLLLLL',     6, 6],
    # 'SoE C Blue 8':    ['ISSSSttttZ',    8, 5],
    # 'SoE C Green 1':   ['jjSSSS',        6, 4],
    # 'SoE C Green 2':   ['ILLOS',         5, 4],
    # 'SoE C Green 3':   ['jSttZ',         4, 5],
    # 'SoE C Green 4':   ['IJLLLO',        4, 6],
    # 'SoE C Green 5':   ['IIILOOStt',     6, 6],
    # 'SoE C Green 6':   ['IIjjLLLOtt',    5, 8],
    # 'SoE C Green 7':   ['IjjjjOOSZ',     6, 6],
    # 'SoE C Green 8':   ['OSSSStttt',     6, 6],
    # 'SoE C Yellow 1':  ['IIjjjOSttZ',   10, 4],
    # 'SoE C Yellow 2':  ['IjLLLLOStt',    8, 5],
    # 'SoE C Yellow 3':  ['JJLOSSttZ',     6, 6],
    # 'SoE C Yellow 4':  ['ILLOZ',         5, 4],
    # 'SoE C Yellow 5':  ['jjLLSZ',        6, 4],
    # 'SoE C Yellow 6':  ['jjLLttttZ',     6, 6],
    # 'SoE C Yellow 7':  ['IjOOSSSttZ',    8, 5],
    # 'SoE C Yellow 8':  ['IILOttZ',       7, 4],
    # 'SoE C Red 1':     ['LSttZ',         4, 5],
    # 'SoE C Red 2':     ['IIIIIIILL',     6, 6],
    # 'SoE C Red 3':     ['jjjjZ',         5, 4],
    # 'SoE C Red 4':     ['ILSttZ',        6, 4],
    # 'SoE C Red 5':     ['IjLLLOOSZ',     6, 6],
    # 'SoE C Red 6':     ['IIIjLLOTTZ',    8, 5],
    # 'SoE C Red 7':     ['LLLLOSSSS',     6, 6],
    # 'SoE C Red 8':     ['IIjLOOSttZ',    5, 8],
